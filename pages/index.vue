<template>
    <div class="home-page">
        <v-layout row wrap justify-center pt-5 pb-5 pl-4 pr-4 intro-section>
            <v-flex>
                <h1 class="display-2">Bruce Aaron McElroy</h1>
                <!--<h2 class="subheading">Designer, Full Stack Developer & Mentor</h2>-->
                <p class="headline">I design, prototype and iterate to create applications that are beautiful and
                    solve problems.</p>
